...
import 'package:first_project/views/event-logic/add_logic/add_event.dart';
import 'package:first_project/views/event-logic/edit_logic/edit_event.dart';
import 'package:first_project/views/event-logic/event_detail.dart';
import 'package:first_project/views/group-logic/group_settings/group_details.dart';
import 'package:first_project/views/group-logic/group_settings/group_settings.dart';
import 'package:first_project/views/group-logic/views/create_group_data.dart';
import 'package:first_project/views/group-logic/views/edit_group_data.dart';
import 'package:first_project/views/group-logic/views/show_groups.dart';
