    ...
    if (notification.groupId != null &&
      ...
      if (userInvited.notifications != null) {
        for (String notificationId in userInvited.notifications!) {
          NotificationUser? ntf = await _notificationManagement
              .notificationService
              .getNotificationById(notificationId);

          if (ntf != null &&
              ntf.groupId == group.id &&
              ntf.questionsAndAnswers.isNotEmpty) {
            String questionKey = ntf.questionsAndAnswers.keys.first;
            ...
            // Optionally update it in the database
            await _notificationManagement.notificationService
