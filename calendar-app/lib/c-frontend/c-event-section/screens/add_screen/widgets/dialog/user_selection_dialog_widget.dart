...
class _UserSelectionDialogState extends State<UserSelectionDialog> {
  ...
  void initState() {
    super.initState();
    tempSelectedUsers = List.from(widget.selectedUsers); // Create a temporary list to hold selected users
  }
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      actions: [
        TextButton(
          onPressed: () {
            Navigator.of(context).pop(tempSelectedUsers); // Return selected users to parent widget
          },
          child: Text('Close'),
        ),
      ],
