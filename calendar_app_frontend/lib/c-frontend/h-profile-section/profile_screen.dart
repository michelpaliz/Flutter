...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _changePhoto() async {
    ...
    try {
      ...
      // 1) Upload to Azure (helper returns blobName + public read URL)
      ...
      // 2) Commit on backend so it stores blobName and photoUrl
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // Avatar + change button (no SAS needed; avatars are public)
          Center(
            child: Stack(
