// lib/c-frontend/b-calendar-section/screens/profile/widgets/profile_details_card.dart
...
class ProfileDetailsCard extends StatelessWidget {
  ...
  final VoidCallback onCopyEmail, onCopyId, onTapUsername, onTapTeams, onTapCalendars, onTapNotifications;
  ...
  Widget build(BuildContext context) {
    ...
    Widget tile({
      ...
      return ListTile(
        ...
        leading: Container(
          height: 40, width: 40,
          decoration: BoxDecoration(color: onSurfaceVar.withOpacity(.12), shape: BoxShape.circle),
          child: Icon(icon),
        ),
        title: Text(title, style: Theme.of(context).textTheme.titleSmall),
        subtitle: subtitle == null ? null : Text(
          subtitle, style: Theme.of(context).textTheme.bodySmall?.copyWith(color: onSurfaceVar)),
        trailing: trailing,
        onTap: onTap,
      );
    }
      ...
      child: Column(
        children: [
          ...
          tile(
            ...
            title: 'Teams',
            subtitle: groupsCount == 1 ? '1 team' : '$groupsCount teams',
            trailing: const Icon(Icons.chevron_right_rounded),
            onTap: onTapTeams,
          ),
          const Divider(height: 0),
          tile(
            ...
            title: 'Calendars',
            subtitle: calendarsCount == 1 ? '1 calendar' : '$calendarsCount calendars',
            trailing: const Icon(Icons.chevron_right_rounded),
