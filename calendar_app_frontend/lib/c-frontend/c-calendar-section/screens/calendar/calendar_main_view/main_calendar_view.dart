...
import 'package:calendar_app_frontend/c-frontend/c-calendar-section/screens/calendar/app_screen_manager.dart';
import 'package:calendar_app_frontend/c-frontend/c-calendar-section/screens/calendar/calendar_main_view/add_event_button.dart';
import 'package:calendar_app_frontend/c-frontend/c-calendar-section/screens/calendar/calendar_main_view/utils/group_permissions_helper.dart';
import 'package:calendar_app_frontend/c-frontend/c-calendar-section/screens/calendar/calendar_screen_logic/calendarUI_manager/calendar_ui_controller.dart';
...
import 'package:calendar_app_frontend/c-frontend/c-calendar-section/screens/calendar/event_screen_logic/ui/events_in_calendar/bridge/event_display_manager.dart';
...
import 'package:calendar_app_frontend/c-frontend/d-event-section/screens/actions/add_screen/add_event/functions/logic/add_event_logic.dart';
...
class _MainCalendarViewState extends AddEventLogic<MainCalendarView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // ✅ Ensure socket exists BEFORE using it
      final token = await context.read<AuthService>().getToken();
      SocketManager().connect(token!);

      // Now it's safe to attach listeners
