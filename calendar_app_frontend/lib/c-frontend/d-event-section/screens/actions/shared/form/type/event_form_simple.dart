...
class _EventFormSimpleState extends State<EventFormSimple> {
  ...
  void initState() {
    ...
    widget.logic.setEventType?.call('simple'); // keep logic aligned
  }
      ...
      children: [
        ...
        RepetitionToggleWidget(
          ...
          onTap: () async {
            ...
            final result = await widget.logic.onShowRepetitionDialog?.call(
                  context,
            ...
            final LegacyRecurrenceRule? rule = result[0] as LegacyRecurrenceRule?;
            final bool isRepeated = result.length > 1 ? result[1] as bool : true;
                ...
                onPressed: canSubmit
                    ? () async {
                        widget.logic.setReminderMinutes(
                          _notifyMe ? (_reminder ?? kDefaultReminderMinutes) : 0,
                        );
