...
class CustomEditableTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return TextFormField(
      ...
      style:
          textStyle ??
          TextStyle(color: contrastTextColor, fontWeight: FontWeight.bold),
      decoration: InputDecoration(
        ...
        prefixIcon: prefixIcon != null
            ? Icon(prefixIcon, color: iconColor ?? contrastTextColor)
            : null,
        counterStyle:
            counterStyle ?? // ✅ use passed style or fallback
