...
import 'package:hexora/b-backend/core/event/domain/event_notification_helper.dart';
import 'package:hexora/b-backend/core/group/domain/group_domain.dart';
import 'package:hexora/b-backend/socket/socket_events.dart';
...
class EventDomain {
  ...
  Future<void> _refreshFromBackend(BuildContext context,
      {bool triggerExternalUpdate = true}) async {
    if (_disposed) return;
  ...
  void _notifyChanges() {
    ...
    scheduleMicrotask(() {
      ...
      _groupDomain.currentGroup = _group;
