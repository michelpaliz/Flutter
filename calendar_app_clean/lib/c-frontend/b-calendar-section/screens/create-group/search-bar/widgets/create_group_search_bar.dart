...
import 'package:first_project/c-frontend/b-calendar-section/screens/create-group/search-bar/controllers/create_group_controller.dart';
import 'package:first_project/c-frontend/b-calendar-section/screens/create-group/search-bar/widgets/group_selected_user_list.dart';
import 'package:first_project/c-frontend/b-calendar-section/utils/search_bar/custome_search_bar.dart';
...
class _CreateGroupSearchBarState extends State<CreateGroupSearchBar> {
  ...
  void _onConfirmChanges() {
    ...
    widget.controller
        .onDataChanged(_controller.usersInGroup, _controller.userRoles);
            ...
            children: [
              ...
              GroupSelectedUsersList(
                ...
                onRemoveUser: (username) {
                  ...
                  _showSnackBar(
                      'User removed: $username'); // ✅ Add feedback here
                },
                onRoleChanged: (username, newRole) {
                  ctrl.changeRole(username, newRole);
                  _showSnackBar(
                      'Role updated: $username is now $newRole'); // ✅ Feedback here
                },
                onConfirmChanges:
