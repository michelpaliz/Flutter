...
import 'widgets/edit_group_body.dart';

class EditGroupData extends StatefulWidget {
  final Group group;
  final List<User> users;

  const EditGroupData({required this.group, required this.users, Key? key}) : super(key: key);
...
class _EditGroupDataState extends State<EditGroupData> {
  ...
  void didChangeDependencies() {
    ...
    _notificationManagement = Provider.of<NotificationManagement>(context, listen: false);
  }
