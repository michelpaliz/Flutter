...
class RepeatEveryRow extends StatelessWidget {
  ...
  String _getTranslatedSpecificFrequency(
      BuildContext context, String frequency) {
    switch (frequency) {
      case 'Daily':
  ...
  String _getTranslatedFrequencyDays(
      BuildContext context, List<String> dayNames) {
  ...
  Widget build(BuildContext context) {
    ...
    switch (selectedFrequency) {
      case 'Daily':
        repeatMessage =
            AppLocalizations.of(context)!.dailyRepetitionInf(repeatInterval);
        break;
      case 'Weekly':
        ...
        break;
      case 'Monthly':
        repeatMessage = AppLocalizations.of(context)!.monthlyRepetitionInf(
